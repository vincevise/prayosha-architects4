    ...
    <div className='p-4  '> 
        {
            ...
            <>
                ...
                <button className='mt-2 px-4 py-2 bg-slate-200 text-black active:bg-slate-300 font-semibold'>Submit</button>
            </>
            ...
            <button className='mt-2 px-4 py-2 active:bg-slate-300 bg-slate-200 text-black font-semibold'>Submit</button>
            </>
        }
