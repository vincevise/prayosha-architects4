...
const Contact = () => {
  ...
  return (
    <>
    <div>
      <div className='text-white pt-24 text-center flex gap-10 justify-center pb-4'>
        <button className={`border-b border-black ${contactState==='contact' && 'border-white' }`}
        onClick={()=>setContactState('contact')}>Contact us</button> 
        <button className={`border-b border-black ${contactState==='career' && 'border-white' }`}
